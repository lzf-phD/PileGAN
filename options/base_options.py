...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='PileGAN',
        ...
        self.parser.add_argument('--input_txt_nc', type=int, default=3, help='# of input txt channels')
        self.parser.add_argument('--output_txt_nc', type=int, default=3, help='# of output txt channels')
        self.parser.add_argument('--gama_txt_D', type=int, default=0.5, help='# txt_D loss 放缩值')
        self.parser.add_argument('--gama_txt_G', type=int, default=0.5, help='# txt_D loss 放缩值')

        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/piles/')
